...
def go(args):
    ...
    # ensure the artifact uploaded before executing next line..
    artifact.wait()
    ######################################
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    non_ordinal_categorical_preproc = make_pipeline(SimpleImputer(
        strategy="most_frequent"), OneHotEncoder())  # YOUR CODE HERE
    ######################################
    ...
    sk_pipe = sk_pipe = Pipeline(steps=[(
        "preprocessor", preprocessor), ("random_forest", random_Forest)])  # YOUR CODE HERE
